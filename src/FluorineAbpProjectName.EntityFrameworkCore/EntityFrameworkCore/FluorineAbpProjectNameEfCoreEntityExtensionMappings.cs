...
public static class FluorineAbpProjectNameEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
             ...
             * USE FluorineAbpProjectNameModuleExtensionConfigurator CLASS (in the Domain.Shared project)
